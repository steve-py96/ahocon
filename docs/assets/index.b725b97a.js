...
`,z=()=>{const[r,e]=l.exports.useState(k),[n,o]=l.exports.useState("");return O(()=>{try{o(JSON.stringify($(r),null,2))}catch({message:t}){o(`parsing error: ${t}`)}},[r],750),u("div",{className:"flex flex-col w-100% h-100%",children:[u("nav",{className:"flex justify-between p-2",children:[i("div",{children:i("b",{children:"Ahocon Playground"})}),u("div",{className:"flex items-center",children:[i("div",{className:"pr-4 color-gray",children:"v0.1.6"}),i("div",{className:"w-20px h-20px",children:i("a",{target:"_blank",href:"https://github.com/steve-py96/ahocon",rel:"noopener noreferrer",className:"color-black",children:i(S,{className:"cursor-pointer w-100% h-100%"})})})]})]}),i("div",{className:"flex w-100% h-100% flex-1",children:i(Y,{small:i(w,{value:n,width:"100%",height:"100%",theme:"vs-dark",options:{minimap:{enabled:!1},readOnly:!0,scrollBeyondLastLine:!1}}),children:i(w,{value:r,onChange:t=>e(t||""),width:"100%",height:"100%",theme:"vs-dark",options:{minimap:{enabled:!1},scrollBeyondLastLine:!1}})})})]})};E.exports.render(i(z,{}),document.querySelector("#root"));
