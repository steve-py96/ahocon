...
`,Y=()=>{const[r,e]=a.exports.useState(X),[n,o]=a.exports.useState("");return E(()=>{try{o(JSON.stringify(x(r),null,2))}catch({message:t}){o(`parsing error: ${t}`)}},[r],750),c("div",{className:"flex flex-col w-100% h-100%",children:[c("nav",{className:"flex justify-between p-2",children:[i("div",{children:i("b",{children:"Ahocon Playground"})}),c("div",{className:"flex items-center",children:[i("div",{className:"pr-4 color-gray",children:"v0.0.4"}),i("div",{className:"w-20px h-20px",children:i("a",{target:"_blank",href:"https://github.com/steve-py96/ahocon",rel:"noopener noreferrer",className:"color-black",children:i(N,{className:"cursor-pointer w-100% h-100%"})})})]})]}),i("div",{className:"flex w-100% h-100% flex-1",children:i(O,{small:i(m,{value:n,width:"100%",height:"100%",theme:"vs-dark",options:{minimap:{enabled:!1},readOnly:!0,scrollBeyondLastLine:!1}}),children:i(m,{value:r,onChange:t=>e(t||""),width:"100%",height:"100%",theme:"vs-dark",options:{minimap:{enabled:!1},scrollBeyondLastLine:!1}})})})]})};y.exports.render(i(Y,{}),document.querySelector("#root"));
